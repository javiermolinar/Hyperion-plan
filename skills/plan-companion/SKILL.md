...
For a review request, inspect the targeted steps and prerequisites against current code. Revise assumptions, descriptions, dependencies, or estimates where needed, preserving completed work and unrelated decisions. Then record the review outcome:
